...
map.getView().fit([12667748.711045, 3462002.901380, 12994620.112608, 3718107.981050], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://blog.manchan.ml">Manchan</a> &middot; ';
